...
public class TestDijkstraSP {
	...
	public void relax1( ){
		setUp1();
		assertTrue("Error: La ruta más corta desde A a B debió ser el nodo con info AB", diGraph.getVertex("B").getEdgeFrontPath().getInfo().equals("EdgeAB"));
		assertTrue("Error: La ruta más corta desde A a C debió ser el nodo con info AC", diGraph.getVertex("C").getEdgeFrontPath().getInfo().equals("EdgeAC"));
		assertTrue("Error: La ruta más corta desde A a D debió ser el nodo con info CD", diGraph.getVertex("D").getEdgeFrontPath().getInfo().equals("EdgeCD"));
		assertTrue("Error: La ruta más corta desde A a E debió ser el nodo con info BE", diGraph.getVertex("E").getEdgeFrontPath().getInfo().equals("EdgeBE"));
	}
	...
	public void relax2(){
		setUp2();
		assertTrue("Error: La ruta más corta desde A a B debió ser el nodo con info AB", diGraph.getVertex("B").getEdgeFrontPath().getInfo().equals("EdgeAB"));
		assertTrue("Error: La ruta más corta desde A a C debió ser el nodo con info AC", diGraph.getVertex("C").getEdgeFrontPath().getInfo().equals("EdgeEC"));
		assertTrue("Error: La ruta más corta desde A a D debió ser el nodo con info CD", diGraph.getVertex("D").getEdgeFrontPath().getInfo().equals("EdgeCD"));
		assertTrue("Error: La ruta más corta desde A a E debió ser el nodo con info BE", diGraph.getVertex("E").getEdgeFrontPath().getInfo().equals("EdgeBE"));
	...
	public void minPath1( ) {
		...
		setUp1();
		vSubA = diGraph.getVertex("A");
		vSubD = diGraph.getVertex("D");
